...
function Footer() {
  return (
    <div>
      <section className="py-10 bg-green-600 sm:pt-16 lg:pt-24">
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          ...
          <div className="flex flex-wrap items-center justify-between">
            <img className="h-8 auto w-54 h-56 border-4 rounded-full md:order-1" src={image2} alt="" />
            <ul className="flex items-center space-x-3 md:order-3">
              <li>
                <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-blue-600 hover:bg-green-600 hover:border-green-600 focus:border-blue-600">
              ...
              <li>
                <a href="#" title="" className="flex items-center justify-center text-white transition-all duration-200 bg-transparent border border-gray-700 rounded-full w-7 h-7 focus:bg-green-600 hover:bg-green-600 hover:border-green-600 focus:border-blue-600">
                  <svg className="w-4 h-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M11.999 7.377a4.623 4.623 0 1 0 0 9.248 4.623 4.623 0 0 0 0-9.248zm0 7.626a3.003 3.003 0 1 1 0-6.005 3.003 3.003 0 0 1 0 6.005zm6.406-7.834a1.078 1.078 0 1 0 0 2.155 1.078 1.078 0 0 0 0-2.155zm2.993-1.143a2.575 2.575 0 0 0-1.82-1.82C17.99 4.68 12 4.68 12 4.68s-5.99 0-7.577.346a2.575 2.575 0 0 0-1.82 1.82C2.257 6.903 2.257 12 2.257 12s0 5.098.346 6.686a2.575 2.575 0 0 0 1.82 1.82c1.587.346 7.577.346 7.577.346s5.99 0 7.577-.346a2.575 2.575 0 0 0 1.82-1.82c.346-1.588.346-6.686.346-6.686s0-5.098-.346-6.686zm-2.243 9.601a4.85 4.85 0 0 1-4.853 4.853H8.698a4.85 4.85 0 0 1-4.853-4.853V8.698a4.85 4.85 0 0 1 4.853-4.853h4.853a4.85 4.85 0 0 1 4.853 4.853v4.853z"></path>
                  </svg>
                </a>
              </li>
            </ul>

            <p className="mt-8 text-sm text-white-600 md:mt-0 md:order-2">&copy; 2024 Wildlif Rescure Hub. All rights reserved.</p>
          </div>
        </div>
      </section>
    </div>
